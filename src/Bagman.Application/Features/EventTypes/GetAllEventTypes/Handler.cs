...
namespace Bagman.Application.Features.EventTypes.GetAllEventTypes;
...
public class GetAllEventTypesHandler : IFeatureHandler<GetAllEventTypesQuery, GetEventTypesResult>
{
    private readonly IEventTypeRepository _repo;

    public GetAllEventTypesHandler(IEventTypeRepository repo)
    {
        _repo = repo;
    }

    public async Task<ErrorOr<GetEventTypesResult>> HandleAsync(
        GetAllEventTypesQuery request,
